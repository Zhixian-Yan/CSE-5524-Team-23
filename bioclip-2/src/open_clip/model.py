...
def convert_weights_to_lp(model: nn.Module, dtype=torch.float16):
    ...
    def _convert_weights(l):
        ...
        # Convert LoRA parameters if present
        from .lora import LoRALayer, LoRAAttention, LoRAMultiheadAttention
        if isinstance(l, (LoRALayer, LoRAAttention, LoRAMultiheadAttention)):
            for param_name in ['lora_A', 'lora_B', 'lora_A_q', 'lora_B_q', 'lora_A_k', 'lora_B_k', 'lora_A_v', 'lora_B_v']:
                param = getattr(l, param_name, None)
