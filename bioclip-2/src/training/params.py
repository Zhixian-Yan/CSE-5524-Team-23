...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        nargs='+',
        default=None,
        help="Target modules to apply LoRA to. Default: ['attn', 'attention']",
    )
    parser.add_argument(
        "--lora-enable-vision",
        default=True,
        action='store_true',
        help="Enable LoRA for vision encoder.",
    )
    parser.add_argument(
        "--lora-enable-text",
        default=True,
        action='store_true',
        help="Enable LoRA for text encoder.",
    )
    parser.add_argument(
        "--lora-weights",
        type=str,
        default=None,
        help="Path to pre-trained LoRA weights to load before training.",
    )
    parser.add_argument(
        "--log-every-n-steps",
        type=int,
